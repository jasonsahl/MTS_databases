...
def main(fasta_dir,reference,wgfast_dir,processors):
    dependencies = ['nasptool','find_duplicates','raxmlHPC-SSE3','convert_external_genome']
...
if __name__ == "__main__":
    ...
    main(options.fasta_dir,options.reference,options.wgfast_dir,options.processors)
